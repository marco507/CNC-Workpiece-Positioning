...
def wangen_select(auswahl_wange, liste_wangen):
    #Wange auswählen
    x_koordinaten_float, y_koordinaten_float = wange_koordinaten_formatieren(liste_wangen[auswahl_wange])
    
    return(x_koordinaten_float, y_koordinaten_float)

def wangenkontur_nachzeichnen(x_koordinaten, y_koordinaten):
    #Wangenkontur fein nachberechnen
    #Die ersten 3 und letzten 2 Werte wegschneiden (Einfahrt und Ausfahrt)
    x_koordinaten = x_koordinaten[3:len(x_koordinaten)-2:]
    y_koordinaten = y_koordinaten[3:len(y_koordinaten)-2:]
    ...
    for i in range(len(x_koordinaten)-1):
        ...
        steigung = (y_koordinaten[i+1] - y_koordinaten[i]) / (x_koordinaten[i+1] - x_koordinaten[i])
        ...
        if(start > x_koordinaten[i+1]):
            while(start > x_koordinaten[i+1]):
                ...
                y_koordinaten_temp = steigung * ((start-raster) - start) + y_koordinaten_temp
                start = start - raster
...
def wangenkontur_mittelpunkt(x_koordinaten_nachgezeichnet, y_koordinaten_nachgezeichnet):
    ...
    for i in range(min(x_koordinaten_int)+1,max(x_koordinaten_int)):
        y_koordinaten_min_max.append([j for j, n in enumerate(x_koordinaten_int) if n == i])
    
    y_koordinaten_mittelpunkt.append(y_koordinaten_int[x_koordinaten_int.index(min(x_koordinaten_int))])
...
def wangenkontur_oberkante(x_koordinaten_int, y_koordinaten_int, y_koordinaten_min_max):
    ...
    y_koordinaten_oberkante.append(y_koordinaten_int[x_koordinaten_int.index(min(x_koordinaten_int))])
...
def x_abstand_maximum(sauger, abstand, x_koordinaten_mittelpunkt, x_koordinaten_int,  y_koordinaten_normalisiert, y_koordinaten_oberkante):
    ...
    try:
        while abstand_soll < (int((sauger/2)) + abstand):
            abstand_soll = y_koordinaten_oberkante[counter] - y_koordinaten_normalisiert[counter]
            counter += 1
        ...
        x_abstand_sauger = x_koordinaten_mittelpunkt[position_sauger_6] - x_koordinaten_mittelpunkt[position_sauger_1]
...
def position_sauger_tisch_1(sauger, x_koordinaten_mittelpunkt, y_koordinaten_normalisiert, x_koordinaten_int, position_sauger_1, position_sauger_6, x_abstand_sauger):
    ...
    for i in x_koordinaten_mittelpunkt:
        if i == position_sauger_1_offset:
            ...
            position_sauger_1_y = y_koordinaten_normalisiert[x_koordinaten_mittelpunkt.index(i)]

    for i in x_koordinaten_mittelpunkt:
        if i == position_sauger_6_offset:
            position_sauger_6_x = i
            position_sauger_6_y = y_koordinaten_normalisiert[x_koordinaten_mittelpunkt.index(i)]
    ...
    if x_abstand_sauger < 900:
        ...
        position_sauger_2_y = y_koordinaten_normalisiert[x_koordinaten_mittelpunkt_offset.index(position_sauger_2_x)] + sauger_halb
        position_sauger_3_y = y_koordinaten_normalisiert[x_koordinaten_mittelpunkt_offset.index(position_sauger_3_x)] - sauger_halb
        ...
        y_position_oberkante = y_koordinaten_oberkante[x_koordinaten_mittelpunkt_offset.index(position_sauger_1_x_offset - sauger_halb)]
        ...
        y_position_oberkante = y_koordinaten_oberkante[x_koordinaten_mittelpunkt_offset.index(position_sauger_6_x_offset + sauger_halb)]
        ...
        #Beide Seiten haben keinen Platz für 2 Sauger
            ...
            position_sauger_4_y = y_koordinaten_normalisiert[x_koordinaten_mittelpunkt_offset.index(position_sauger_4_x)] + sauger_halb
            position_sauger_5_y = y_koordinaten_normalisiert[x_koordinaten_mittelpunkt_offset.index(position_sauger_5_x)] - sauger_halb
        ...
        #Sauger 2 (Träger 9)
        position_sauger_2_x = position_sauger_1_x_offset + 300 #Abstand der Träger
        position_sauger_2_y = y_koordinaten_normalisiert[x_koordinaten_mittelpunkt_offset.index(position_sauger_2_x)]
        ...
        position_sauger_5_y = y_koordinaten_normalisiert[x_koordinaten_mittelpunkt_offset.index(position_sauger_5_x)]
        ...
        #Sauger 3 (Träger 10)
        position_sauger_3_x = position_sauger_1_x_offset + 600
        position_sauger_3_y = y_koordinaten_normalisiert[x_koordinaten_mittelpunkt_offset.index(position_sauger_3_x)]
    
        #Sauger 4 (Träger 11)
        position_sauger_4_x = position_sauger_1_x_offset + 900
        position_sauger_4_y = y_koordinaten_normalisiert[x_koordinaten_mittelpunkt_offset.index(position_sauger_4_x)]
...
def sauger_positionen_berechnen(sauger, auswahl_tisch, x_koordinaten_mittelpunkt, y_koordinaten_normalisiert, x_koordinaten_int, y_koordinaten_int, position_sauger_1, position_sauger_6, x_abstand_sauger):
    ...
    if auswahl_tisch == 0:
        x_koordinaten_offset, y_koordinaten_int, positionen_sauger_x, positionen_sauger_y, x_offset, y_offset, x_koordinaten_mittelpunkt_offset = position_sauger_tisch_0(sauger, x_koordinaten_mittelpunkt, y_koordinaten_normalisiert, x_koordinaten_int, y_koordinaten_int, position_sauger_1, position_sauger_6, x_abstand_sauger)
    
    elif auswahl_tisch == 1:
        x_koordinaten_offset, positionen_sauger_x, positionen_sauger_y, x_offset, x_koordinaten_mittelpunkt_offset = position_sauger_tisch_1(sauger, x_koordinaten_mittelpunkt, y_koordinaten_normalisiert, x_koordinaten_int, position_sauger_1, position_sauger_6, x_abstand_sauger)
        
    elif auswahl_tisch == 2:
        x_koordinaten_offset, y_koordinaten_int, positionen_sauger_x, positionen_sauger_y, x_offset, y_offset, x_koordinaten_mittelpunkt_offset = position_sauger_tisch_2(sauger, x_koordinaten_mittelpunkt, y_koordinaten_normalisiert, x_koordinaten_int, y_koordinaten_int, position_sauger_1, position_sauger_6, x_abstand_sauger)
        
    elif auswahl_tisch == 3:
         x_koordinaten_offset, y_koordinaten_int, positionen_sauger_x, positionen_sauger_y, x_offset, y_offset, x_koordinaten_mittelpunkt_offset = position_sauger_tisch_3(sauger, x_koordinaten_mittelpunkt, y_koordinaten_normalisiert, x_koordinaten_int, y_koordinaten_int, position_sauger_1, position_sauger_6, x_abstand_sauger)
...
def wange_plotten(auswahl_tisch, wange, sauger, x_offset, y_offset, x_koordinaten_offset, y_koordinaten_int, x_sauger, y_sauger, x_koordinaten_tisch_links, y_koordinaten_tisch_links, x_koordinaten_traeger, y_koordinaten_traeger, x_koordinaten_tisch_rechts, y_koordinaten_tisch_rechts, platte_koordinaten):
    ...
    if auswahl_tisch == 0:
        ...
        plt.annotate(bemaßung, xy=(min(x_sauger[0]) , min(y_sauger[0])), xytext=(min(x_sauger[0]) +abstand , -abstand))
        
        #Horizontal
        bemaßung = str(int(round((min(x_sauger[0])-600)/10,0)))
        plt.annotate(bemaßung, xy=(min(x_sauger[0]), min(y_sauger[0]) ), xytext=(600 -abstand*1.5, min(y_sauger[0])))
        
        #Sauger - Wange
        plt.subplot(2,1,2)
        #Sauger 1
        #Vertikal
        bemaßung = str(int(round((min(y_sauger[0]) - min(platte_koordinaten[1]))/10,0)))
        plt.annotate(bemaßung, xy=(min(x_sauger[0]) , min(y_sauger[0])), xytext=(min(x_sauger[0]) , min(platte_koordinaten[1]) -abstand))
        
        #Horizontal
        bemaßung = str(int(round((min(x_sauger[0]) - min(platte_koordinaten[0]))/10,0)))
        plt.annotate(bemaßung, xy=(min(x_sauger[0]), min(y_sauger[0]) ), xytext=(min(platte_koordinaten[0]) - abstand, min(y_sauger[0])))
    ...
    #Normale Wangen Tisch 1
        ...
        if x_abstand_sauger < 900:
            ...
            plt.annotate(bemaßung, xy=(min(x_sauger[2])  , min(y_sauger[2])), xytext=(min(x_sauger[2]) , -abstand))
            
            #Sauger 6
            #Vertikal
            bemaßung = str(int(round(min(y_sauger[5])/10,0)))
            plt.annotate(bemaßung, xy=(min(x_sauger[5])  , min(y_sauger[5])), xytext=(min(x_sauger[5]) , -abstand))
            ...
            #Sauger 6
            #Vertikal
            bemaßung = str(int(round((min(y_sauger[5]) - min(platte_koordinaten[1]))/10,0)))
            plt.annotate(bemaßung, xy=(min(x_sauger[5]) , min(y_sauger[5])), xytext=(min(x_sauger[5]) , min(platte_koordinaten[1])))
        ...
        #4 Träger - Sauger 1,3,5,6
            ...
            #Vertikal
            bemaßung = str(int(round(min(y_sauger[0])/10,0)))
            plt.annotate(bemaßung, xy=(min(x_sauger[0]) , min(y_sauger[0])), xytext=(min(x_sauger[0]) , -abstand))
            ...
            plt.annotate(bemaßung, xy=(min(x_sauger[4])  , min(y_sauger[4])), xytext=(min(x_sauger[4]), -abstand))
            ...
            #Vertikal
            bemaßung = str(int(round((min(y_sauger[5]) - min(platte_koordinaten[1]))/10,0)))
            plt.annotate(bemaßung, xy=(min(x_sauger[5]) , min(y_sauger[5])), xytext=(min(x_sauger[5]) , min(platte_koordinaten[1]) - abstand))
        ...
        #5 Träger - Sauger 1,2,4,5,6
            ...
            plt.annotate(bemaßung, xy=(min(x_sauger[1]) , min(y_sauger[1])), xytext=(min(x_sauger[1]) , -abstand))
        
            #Sauger 4
            #Vertikal
            bemaßung = str(int(round(min(y_sauger[3])/10,0)))
            plt.annotate(bemaßung, xy=(min(x_sauger[3]) , min(y_sauger[3])), xytext=(min(x_sauger[3]) , -abstand))
        ...
        if x_abstand_sauger < 2100:
            ...
            #Horizontal
            bemaßung = str(int(round((min(x_sauger[0]) - min(platte_koordinaten[0]))/10,0)))
            plt.annotate(bemaßung, xy=(min(x_sauger[0]), min(y_sauger[0]) ), xytext=(min(platte_koordinaten[0]) - abstand*1.5, min(y_sauger[0]) ))
        ...
        #Horizontal
        bemaßung = str(int(round((min(x_sauger[0])-600)/10,0)))
        plt.annotate(bemaßung, xy=(min(x_sauger[0]), min(y_sauger[0]) ), xytext=(600 -abstand*1.8, min(y_sauger[0])))
        ...
        #Horizontal
        bemaßung = str(int(round((min(x_sauger[0]) - min(platte_koordinaten[0]))/10,0)))
        plt.annotate(bemaßung, xy=(min(x_sauger[0]), min(y_sauger[0])), xytext=(min(platte_koordinaten[0]) -abstand*1.8, min(y_sauger[0])))
...
def position_sauger_tisch_2(sauger, x_koordinaten_mittelpunkt, y_koordinaten_normalisiert, x_koordinaten_int, y_koordinaten_int, position_sauger_1, position_sauger_6, x_abstand_sauger):
    ...
    while abstand_soll < (sauger + 5):
        abstand_soll = x_koordinaten_mittelpunkt_offset[counter] - x_koordinaten_mittelpunkt_offset[position_sauger_1]
        counter += 1
    ...
    while abstand_soll < (sauger + 5):
        abstand_soll = x_koordinaten_mittelpunkt[counter] - x_koordinaten_mittelpunkt[position_sauger_2]
        counter += 1
...
def position_sauger_tisch_3(sauger, x_koordinaten_mittelpunkt, y_koordinaten_normalisiert, x_koordinaten_int, y_koordinaten_int, position_sauger_1, position_sauger_6, x_abstand_sauger):
    ...
    while abstand_soll < (sauger + 5):
        abstand_soll = x_koordinaten_mittelpunkt_offset[position_sauger_6] - x_koordinaten_mittelpunkt_offset[counter]
        counter -= 1
    ...
    while abstand_soll < (sauger + 5):
        abstand_soll = x_koordinaten_mittelpunkt_offset[position_sauger_5] - x_koordinaten_mittelpunkt_offset[counter]
        counter -= 1
...
def position_sauger_tisch_0(sauger, x_koordinaten_mittelpunkt, y_koordinaten_normalisiert, x_koordinaten_int, y_koordinaten_int, position_sauger_1, position_sauger_6, x_abstand_sauger):
    ...
    if x_abstand_sauger < sauger * 5:
        #Sauger 1
        position_sauger_1_x = position_sauger_1 + ((x_abstand_sauger - sauger * 4) / 2)
        position_sauger_1_y = min(y_koordinaten_int) + ((max(y_koordinaten_int) - min(y_koordinaten_int)) / 2)
        ...
        #Sauger 6
        position_sauger_6_x = position_sauger_6 - ((x_abstand_sauger - sauger * 4) / 2)
        position_sauger_6_y = position_sauger_1_y
        
    #Platz für 5 Sauger
    elif x_abstand_sauger < sauger * 6:
        #Sauger 1
        position_sauger_1_x = position_sauger_1 + ((x_abstand_sauger - sauger * 5) / 2)
        position_sauger_1_y = min(y_koordinaten_int) + ((max(y_koordinaten_int) - min(y_koordinaten_int)) / 2)
        ...
        #Sauger 6
        position_sauger_6_x = position_sauger_6 - ((x_abstand_sauger - sauger * 5) / 2)
        position_sauger_6_y = position_sauger_1_y
        
    #Platz für 6 Sauger
    else:
        #Sauger 1
        position_sauger_1_x = position_sauger_1 + ((x_abstand_sauger - sauger * 6) / 2)
        position_sauger_1_y = min(y_koordinaten_int) + ((max(y_koordinaten_int) - min(y_koordinaten_int)) / 2)
        ...
        #Sauger 6
        position_sauger_6_x = position_sauger_6 - ((x_abstand_sauger - sauger * 6) / 2)
        position_sauger_6_y = position_sauger_1_y
...
for i in range(len(liste_wangen)):
    ...
    x_koordinaten_nachgezeichnet, y_koordinaten_nachgezeichnet = wangenkontur_nachzeichnen(x_koordinaten, y_koordinaten)
    
    #Mittelpunktlinie der Wange ausrechnen
    x_koordinaten_mittelpunkt, x_koordinaten_int, y_koordinaten_int, y_koordinaten_normalisiert, y_koordinaten_min_max = wangenkontur_mittelpunkt(x_koordinaten_nachgezeichnet, y_koordinaten_nachgezeichnet)
    
    #Oberkante der Wangenkontur ausrechnen
    y_koordinaten_oberkante = wangenkontur_oberkante(x_koordinaten_int, y_koordinaten_int, y_koordinaten_min_max)
    
    #Maximalen Abstand in X der Sauger 1 und 6 berechnen
    x_abstand_sauger, position_sauger_1, position_sauger_6, zwang_auswahl = x_abstand_maximum(sauger, abstand, x_koordinaten_mittelpunkt, x_koordinaten_int, y_koordinaten_normalisiert, y_koordinaten_oberkante)
    ...
    x_koordinaten_offset, y_koordinaten_int, positionen_sauger_x, positionen_sauger_y, x_offset, y_offset, x_koordinaten_mittelpunkt_offset = sauger_positionen_berechnen(sauger, auswahl_tisch, x_koordinaten_mittelpunkt, y_koordinaten_normalisiert, x_koordinaten_int, y_koordinaten_int, position_sauger_1, position_sauger_6, x_abstand_sauger)
    
    #Saugerkonturen berechnen
    x_sauger, y_sauger = sauger_kontur(sauger, positionen_sauger_x, positionen_sauger_y)
    ...
    #Platte berechnen
    platte_koordinaten = platte_zeichnen(x_koordinaten_offset, y_koordinaten_int)
    
    #Bemaßen und Wange plotten
    wange_plotten(auswahl_tisch, i, sauger,  x_offset, y_offset, x_koordinaten_offset, y_koordinaten_int, x_sauger, y_sauger, x_koordinaten_tisch_links, y_koordinaten_tisch_links, x_koordinaten_traeger, y_koordinaten_traeger, x_koordinaten_tisch_rechts, y_koordinaten_tisch_rechts, platte_koordinaten)
